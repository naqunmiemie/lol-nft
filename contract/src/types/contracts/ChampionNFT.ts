...
export interface ChampionNFT extends BaseContract {
  ...
  functions: {
    ...
    luuTokenAddr(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    luuTokenAddr(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    luuTokenAddr(overrides?: CallOverrides): Promise<PopulatedTransaction>;
