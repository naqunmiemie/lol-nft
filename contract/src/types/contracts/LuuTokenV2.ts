...
export interface LuuTokenV2Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "buyLuuTokenByUsdt",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "championAddr",
    values?: undefined
  ): string;
...
export interface LuuTokenV2 extends BaseContract {
  ...
  functions: {
    ...
    championAddr(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    championAddr(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    championAddr(overrides?: CallOverrides): Promise<PopulatedTransaction>;
